...
HGMT_OBJ := src/hgmt_lor_creator.o \
            src/hgmt_structs.o \
            src/linear_algebra.o \
            src/helper_functions.o \
            src/compton_chain_ordering.o \
...
# New compact NEMA pipeline
NEMA_OBJ := src/nema_lor_creator.o \
            src/hgmt_structs.o \
            src/linear_algebra.o \
            src/helper_functions.o \
            src/read_write.o \
...
all: hgmt_lor_creator nema_lor_creator

hgmt_lor_creator: $(HGMT_OBJ)
	$(CXX) -o $@ $(HGMT_OBJ) $(TORCH_LIBS) $(LDLIBS)

nema_lor_creator: $(NEMA_OBJ)
	$(CC) -o $@ $(NEMA_OBJ) $(LDLIBS)
...
-include $(HGMT_OBJ:.o=.d)
-include $(NEMA_OBJ:.o=.d)

.PHONY: all clean
clean:
	rm -f $(HGMT_OBJ) $(HGMT_OBJ:.o=.d) \
	      $(NEMA_OBJ) $(NEMA_OBJ:.o=.d) \
	      hgmt_lor_creator nema_lor_creator